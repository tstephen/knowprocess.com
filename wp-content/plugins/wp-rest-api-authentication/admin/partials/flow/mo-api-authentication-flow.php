...
function mo_api_authentication_config_app_settings()
{
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST' &&  current_user_can('administrator') ) {
		...
		}  else if ( ( isset( $_POST['option'] ) && $_POST['option'] == "mo_api_authentication_postman_file" ) && isset($_REQUEST['mo_api_authentication_postman_fields']) && wp_verify_nonce(sanitize_text_field(wp_unslash($_REQUEST['mo_api_authentication_postman_fields'])), 'mo_api_authentication_postman_config') ) {
			$method = isset( $_POST[ 'file_name' ] ) ? $_POST[ 'file_name' ] : '';
			if( $method !== '' ) {
