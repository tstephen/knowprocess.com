						...
						<tr>
							...
							<td>
								<select required style="<?php echo $democss; ?>" name="mo_oauth_client_demo_plan" id="mo_oauth_client_demo_plan_id">
									...
									<option value="WP OAuth/OpenID Connect Client Standard Plugin">WP OAuth/OpenID Connect Standard Plugin</option>
									<option value="WP OAuth/OpenID Connect Client Premium Plugin">WP OAuth/OpenID Connect Premium Plugin</option>
									<option value="WP OAuth/OpenID Connect Client Enterprise Plugin">WP OAuth/OpenID Connect Enterprise Plugin</option>
